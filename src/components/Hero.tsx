        ...
        <Container>
          ...
          >
            ...
            >
              ...
              <span className="golden-accent font-medium">Expertise reconnue. Technologies modernes. Prothèses de qualité.</span>
            </motion.p>
            ...
            >
              <p className="text-accent-text-light text-sm tracking-[0.2em] uppercase font-medium">
                Découvrir nos services de laboratoire
              </p>
              <motion.div
